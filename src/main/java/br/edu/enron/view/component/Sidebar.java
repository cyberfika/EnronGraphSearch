...
/**
 * Left sidebar matching the design_template sidebar.
 *
 * <p>Sections: FONTE / CORPUS, dataset card, RESUMO / LIVE, DIRETÓRIO list.</p>
 */
public final class Sidebar extends JPanel {
    ...
    public Sidebar(ContactGraph graph, int totalMessages, double density) {
        ...
        setPreferredSize(new Dimension(264, 0));
        setMinimumSize(new Dimension(264, 0));
        setMaximumSize(new Dimension(264, Integer.MAX_VALUE));
    ...
    private JPanel sideSection(String left, String right) {
        ...
        p.setMaximumSize(new Dimension(264, 30));
    ...
    private JPanel fonteInfo(ContactGraph graph) {
        ...
        p.setMaximumSize(new Dimension(264, 64));
    ...
    private JPanel datasetCard(ContactGraph graph) {
        ...
        p.setMaximumSize(new Dimension(264, 60));
